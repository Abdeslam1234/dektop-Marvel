...
import card2 from "./assets/icons/anousi.png";
import card3 from "./assets/icons/arwa.png";
import card4 from "./assets/icons/arwati.png";
import card5 from "./assets/icons/iyad.png";
import card8 from "./assets/icons/mano.png";
...
function App() {
  ...
  return (
    <div
      ...
      className="app-containerx"
    >
      <div className="header" style={{ textAlign: "center", color: "white" }}>
        <h1>Memory Marvel</h1>
      </div>
